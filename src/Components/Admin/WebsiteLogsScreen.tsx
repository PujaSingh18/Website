...
export default function WebsiteLogsScreen() {
  ...
  return (
    <section className="main-container w-full justify-start items-start gap-4">
      ...
      <div className="w-full justify-start flex flex-col mt-4 gap-4">
        ...
        <select
          name=" "
          id=""
          className=" bg-white h-10 w-2/3 rounded-md mb-2 mt-2 "
        >
      ...
      <div className="mt-6 gap-4">
        <button
          type="submit"
          className="px-4 py-3 text-sm rounded-lg text-white transition-all duration-300 ease-in-out active:scale-90 font-sm bg-themeColor mb-10 mt-4 flex flex-col "
        >
          Send Notification
        </button>
      </div>
